...
//  ImageCore
//
//  Created by Chatchai on 10/3/2557 BE.
...
class ViewController: UIViewController, UINavigationControllerDelegate,UIImagePickerControllerDelegate{
    ...
    var orientaion: UIImageOrientation = .Up
    ...
    @IBAction func amountSliderValueChanged(sender:UISlider){
        ...
        let newImage = UIImage(CGImage: cgimg, scale:1, orientation: orientaion)
    ...
    func imagePickerController(picker: UIImagePickerController!, didFinishPickingMediaWithInfo info: NSDictionary!) {
        ...
        orientaion = gotImage.imageOrientation
